...
const LoginForm = (props: Props) => {
  ...
  return (
    <div className="container bg-white rounded-2xl md:rounded-none py-12 px-6 md:py-14 lg:px-0">
      <form onSubmit={(event) => event.preventDefault()}>

        <div className="mb-6">
          <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Username</label>
          <input type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required onChange={(e) => setUsername(e.target.value)}/>
        </div>
