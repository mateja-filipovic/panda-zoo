...
const ProfileForm = (props: ProfileformProps) => {
  ...
  const handleSaveChangesClick = () => {
    UserService.updateUser(userId, username, name, lastName, phoneNumber, email);
  }
    ...
    <div className="container bg-white lg:rounded-3xl rounded-2xl py-6 px-6 md:py-14 md:px-12">
      <form onSubmit={(event) => event.preventDefault()}>
        ...
        <div className="mb-6">
          ...
          <input type="text" value={username} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="name@flowbite.com" required 
        ...
        <div className="w-full flex justify-end">
          <button className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mt-3"
